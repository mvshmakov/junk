...
window.onload = function() {
    var documentHeight = innerHeight,
        documentWidth = innerHeight;
    ...
    xhr.open("GET", "/get_email_children?email=info@ru.mailstudiomoderna.com", false);
    xhr.send();
    ...
    if (xhr.status != 200) {
        ...
        d3.json(JSON.parse(xhr.responseText), function(error, json) {
